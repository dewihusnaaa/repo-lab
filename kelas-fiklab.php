...
<div class="wrapper">
        ...
        <div class="main">
            <nav class="navbar navbar-expand px-4 py-3" style="background: linear-gradient(to right, #ffc107 , #ff4500);">
                <h2 style="color: white">FIKLAB</h2>
            </nav> 
                <main class="content px-3 py-4">
                <div class="container-fluid">
                    <div class="container-fluid">
                        <h1 class="mt-4">Jadwal Kelas FIKLAB</h1>
                            <div class="card mb-5">
                                ...
                                <div class="card-body">
                                    <table class="table table-bordered text-center">
                                        ...
                                        <tr>
                                            ...
                                            <td rowspan="3" style="vertical-align: middle;">FL-201</td>
                                            <td>07:40</td>
                                            <td>08:40</td>
                                        </tr>
                                        <tr>
                            ...
                            <div class="card mb-5">
                                ...
                                <div class="card-body">
                                    <table class="table table-bordered text-center">
                                        ...
                                        <tr>
                                            <td rowspan="15" style="vertical-align: middle;">Senin-Jumat</td>
                                            <td rowspan="3" style="vertical-align: middle;">FL-301</td>
                                            <td>07:00</td>
                                            <td>12:00</td>
                                        </tr>
                                        <tr>
                            ...
                            <div class="card mb-5">
                                ...
                                <div class="card-body">
                                    <table class="table table-bordered text-center">
                                        ...
                                        <tr>
                                            <td rowspan="15" style="vertical-align: middle;">Senin-Jumat</td>
                                            <td rowspan="3" style="vertical-align: middle;">FL-401</td>
                                            <td>07:00</td>
                                            <td>12:00</td>
                                        </tr>
                                        <tr>
